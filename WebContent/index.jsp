      ...
      <div id="navigation" class="wrapper">
          ...
          <div class="header-hidden-inner container">
            ...
            <div class="col-md-4"></div>
              <div class="col-md-3">
                ...
                <p>Delight is a super flexible responsive theme with a modest design touch.</p>
        ...
        <div class="header">
          <div class="header-inner container">
            ...
            %>  
            <li class="hidden-xs"><i class="fa fa-sign-in text-primary"></i> <a href="logout" class="text-uppercase" onClick="logout()">Logout</a></li>
            ...
            <%  
             ...
             <%--   <c:choose><c:when test="${!empty custemail}">
                  <li class="hidden-xs"><i class="fa fa-sign-in text-primary"></i> <a href="index.jsp" class="text-uppercase">Logout</a></li>
                 </c:when>
                 <c:otherwise>
                 <li class="hidden-xs"><i class="fa fa-sign-in text-primary"></i> <a href="login.jsp" class="text-uppercase">Login</a></li>
                 </c:otherwise>
                ...
                <div class="row">
                  <div class="col-md-6 col-md-push-6 item-caption">
                    <h2 class="h1 text-weight-light">
                      Welcome to <span class="text-primary">Delitte</span>
                    </h2>
                    <h4>
                     New Thinking Reveals New Possibilities
                    </h4>
                    <p>Business used to rely on technology, now technology is business, and IT experience is the customer experience. Navigating and harnessing digital transformation is how to get ahead—creating new customer experiences, optimizing core business operations, accelerating new products and services, or finding new markets.</p>
                    <a href="https://bootstrapmade.com" class="btn btn-more btn-lg i-right">Learn More<i class="fa fa-plus"></i></a>
                  </div>
...
-->
      <div class="block block-pd-sm block-bg-grey-dark block-bg-overlay block-bg-overlay-6 text-center" data-block-bg-img="https://picjumbo.imgix.net/HNCK1088.jpg?q=40&amp;w=1650&amp;sharp=30" data-stellar-background-ratio="0.3">
        ...
        <p>
          <a href="register.jsp" class="btn btn-more btn-lg i-right">Join them today! <i class="fa fa-angle-right"></i></a>
        </p>
      </div>
    ...
    <footer id="footer" class="block block-bg-grey-dark" data-block-bg-img="img/bg_footer-map.png" data-stellar-background-ratio="0.4">
      <div class="container">
        ...
        <div class="row" id="contact">
          ...
          <div class="col-md-3">
            <address>
              <strong>Delight Inc</strong>
              <br>
              <i class="fa fa-map-pin fa-fw text-primary"></i> Startup Campus Pangyo
              <br>
              <i class="fa fa-phone fa-fw text-primary"></i> 019223 8092344
              <br>
              <i class="fa fa-envelope-o fa-fw text-primary"></i> outlier@delightinc.com
              <br>
            </address>
          </div>
